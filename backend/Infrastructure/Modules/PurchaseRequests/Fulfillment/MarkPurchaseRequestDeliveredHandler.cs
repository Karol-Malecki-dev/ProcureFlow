...
/// <summary>Applies the Ordered to Delivered transition for Procurement.</summary>
public sealed class MarkPurchaseRequestDeliveredHandler : IMarkPurchaseRequestDeliveredHandler
{
    ...
    public MarkPurchaseRequestDeliveredHandler(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            request.MarkDelivered(command.FulfillmentNote);
